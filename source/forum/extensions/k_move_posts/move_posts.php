...
/**
 * K Move Posts extension file
 * based on Pun Move Posts
 *
 * @copyright Copyright (C) 2010 KiRiK (kirik-ch.ru)
			...
			<fieldset class="frm-group group<?php echo ++$forum_page['group_count'] ?>">
				<div class="sf-set set<?php echo ++$forum_page['item_count'] ?>">
					<div class="sf-box select">
						<label for="fld<?php echo ++$forum_page['fld_count'] ?>"><span><?php echo $lang_k_move_posts['Destination topic']?></span></label><br />
						<span class="fld-input"><input type=text id="<?php echo $forum_page['fld_count'] ?>" name="move_to_topic" size=10 /></span>
					</div>
				</div>
...
if (isset($_POST['move_posts_to']))
{
	...
	$query = array(
		'SELECT'	=> 't.subject, t.poster, t.first_post_id, t.posted, t.num_replies',
		'FROM'		=> 'topics AS t',
		'WHERE'		=> 't.id='.$move_to_topic.' AND t.moved_to IS NULL'
	);
