<?php
/**
 * @file AttributeRequest.php
 * @brief Contains interface Ext_OpenID_AttributeRequest.
 */
...
/**
 * @brief Interface for OpenID attribute request (e.g. SReg or AX).
 */
interface Ext_OpenID_AttributeRequest
{
	/**
	 * @brief Builds attribute request.
