 ...
 *
 * @copyright (C) 2008-2009 PunBB, partially based on Attachment Mod by Frank Hagstrom, перевод by KiRiK (kirik-ch.ru)
...
'Mb'					=>	' mb',
'B'						=>	' b',
'Since'					=>	'%s загрузок с %s',
'Never download'		=>	'файл ни разу не был скачан.',
'Since (title)'			=>	'%s загрузок с %s',
'Attachment icon'		=>	'Иконка',

'Number existing'		=>	'Прикреплен #<strong>%s</strong>',
...
'Download perm error'	=>	'У Вас недостаточно прав для загрузки файлов, прикрепленных к этому сообщению.',
'None'					=>	'None',
